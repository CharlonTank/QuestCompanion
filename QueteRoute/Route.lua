...
ns.route = {
    ["Horde"] = {
        ...
        quetes = {
            ...
            [93926] = { titre = "0", niveau = 8, contributeurs = 1, prendre = nil, rendre = { map = 2521, x = 0.423, y = 0.621, pnj = "Peacekeeper Vaaniel" }, objectifs = {  } },
            ...
            [92516] = { titre = "0", niveau = 9, contributeurs = 1, prendre = nil, rendre = { map = 2521, x = 0.444, y = 0.45, pnj = "Teeri Wellwind" }, objectifs = {  } },
            [92550] = { titre = "0", niveau = 9, contributeurs = 1, prendre = nil, rendre = { map = 2521, x = 0.456, y = 0.455, pnj = "Constable Aonda" }, objectifs = { [3] = { map = 2521, x = 0.502, y = 0.568 } } },
            [92551] = { titre = "0", niveau = 9, contributeurs = 1, prendre = nil, rendre = { map = 2521, x = 0.452, y = 0.452, pnj = "Danarii Bellowveil" }, objectifs = {  } },
            [93951] = { titre = "0", niveau = 9, contributeurs = 1, prendre = nil, rendre = { map = 2521, x = 0.449, y = 0.442, pnj = "Taleen Shimmerthread" }, objectifs = {  } },
